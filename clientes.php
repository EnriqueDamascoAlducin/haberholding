    ...
    <div class="card-body login-card-body">
      ...
      <form  id="formularioLogin">
        <div class="input-group mb-3">
          <input type="number" class="form-control" placeholder="Cliente Id" id="noempleado" name="noempleado">
...
<script type="text/javascript">
  ...
  $("#formularioLogin").submit(function(event){
    ...
    if(valorempleado ==''){
      swal({
        title: "Error",
        text: "Debes Capturar tu Número de Cliente",
        icon: "error",
        button: "Regresar",
      });
      setTimeout(function(){
    ...
    $.ajax({
      ...
      data:{empleado:valorempleado,contrasena:valorcontrasena, tipo_usuario : 'externo'},
      type:'POST',
