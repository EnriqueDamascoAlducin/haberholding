<?php
	...
	$usuario = $_POST['id'];
	$equipos = $con->query("SELECT serie as text, id as value from equipos where status = 1 and id not in (Select id from usuarios_equipo Where status<> 0 and id_usuario <> ".$_POST['id']."); ");
...
<table class="table" id="equipoInfo">
</table>
